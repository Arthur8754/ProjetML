...
def main():
    ...
    # 3. TESTS SUR LE RÉSEAU DE NEURONES MULTICOUCHES :
    print("-------------------------------")
    print("TESTS RÉSEAU DE NEURONES : ")
    testRN = testReseauNeurones.testReseauNeurones()
    
    # Test 1 : cas de base
    err_train1, err_valid1 = testRN.test(x_train, t_train, 0.01)
